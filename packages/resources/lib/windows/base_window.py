...
class FontUtils:
	def execute_custom_fonts(self):
		...
		skin_files = kodi_utils.list_dirs(kodi_utils.translate_path('special://home/addons/plugin.video.fenlight.am/resources/skins/Default/1080i/'))[1]
	...
	def replace_font(self, window, replacement_values):
		file = kodi_utils.translate_path('special://home/addons/plugin.video.fenlight.am/resources/skins/Default/1080i/' + window)
